...
func TestRuntime_Open(t *testing.T) {
	t.Run("opens and composes application dependencies", func(t *testing.T) {
		...
		if runtime.Subjects() == nil || runtime.Thoughts() == nil || runtime.Metrics() == nil || runtime.Events() == nil || runtime.TimelineView() == nil {
		...
		if runtime.Thoughts() != nil || runtime.Metrics() != nil || runtime.Events() != nil || runtime.TimelineView() != nil {
